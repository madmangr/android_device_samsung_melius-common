 ...
 * {@hide}
 */
public class MeliusSPRRIL extends RIL implements CommandsInterface {
    ...
    public MeliusSPRRIL(Context context, int preferredNetworkType,
            int cdmaSubscription, Integer instanceId) {
        this(context, preferredNetworkType, cdmaSubscription);
    }

    public MeliusSPRRIL(Context context, int networkMode,
